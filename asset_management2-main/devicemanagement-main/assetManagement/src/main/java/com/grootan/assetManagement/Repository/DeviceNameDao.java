...
public interface DeviceNameDao extends JpaRepository<DeviceName,Long> {
    ...
    @Query(value = "select u from DeviceName u where u.id=?1")
    public DeviceName getByDeviceNameId(Long id);
}